...
\begin{frame}[fragile, t]
  ...
  % Die vertikalen Abstände zwischen den Zeilen müssen meist nachjustiert werden
  \vskip-2ex
  ...
  \begin{columns}[onlytextwidth, T]
      ...
      \begin{column}{.31\textwidth}
        \begin{block}{Kollaboration}
          ...
          Wer einen GitHub-Account hat, kann auch direkt auf der Projektseite ein Issue erstellen.
  ...
  \begin{columns}[onlytextwidth, T]
      \begin{column}{.75\textwidth}
        \begin{block}{Verwendung}
          Die Inhalte des Posters werden hauptsächlich mit zwei Umgebungen gesetzt: \textit{block} und \textit{columns}.
          Hier ein Beispiel:
  ...
  \end{columns}
      ...
      \begin{column}{.21\textwidth}
        \begin{block}{Download der Dokumentenklasse}
          \qrcode[height=7.2cm, padding, hyperlink]{https://github.com/jcalov/HFT-Poster/}
          \centering{\small{\hyperlink{https://github.com/jcalov/HFT-Poster}{github.com/jcalov/HFT-Poster}}}
        \end{block}
      \end{column}
  \end{columns}
